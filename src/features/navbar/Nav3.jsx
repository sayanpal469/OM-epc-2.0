...
//   { name: "Calls", link: "/calls", current: false },
//   { name: "Reports", link: "/reports", current: false },
//   { name: "Expense", link: "/expense", current: false },
//   { name: "Create Engineer", link: "/create-engineers", current: false },
//   { name: "View Engineer", link: "/view-engineers", current: false },
// ];
...
export default function Nav3({ role, engId }) {
  ...
  return (
    <div>
      ...
      <div className="h-screen flex-1 mt-">
        <Outlet />
      </div>
    </div>
  );
