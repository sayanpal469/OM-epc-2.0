  ...
  return (
    <div className="mx-5">
      <div className="flex justify-center items-center w-full px-5 mb-5">
        <div className="relative flex items-center justify-end w-full sm:w-1/2 shadow-lg h-[250px] my-4">
          <div className="w-[50%] flex flex-col items-center justify-center sm:w-[70%] h-full">
            ...
            <button
              onClick={openModal}
              className="bg-transparent my-5 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"
            >
              Add Expense
            </button>
          </div>
          ...
          >
            <span className="text-white text-4xl sm:text-6xl mb-2">
              Rs 2000
            </span>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
              className="inline-block align-bottom bg-white h-full rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
              role="dialog"
              aria-modal="true"
                    ...
                    <form>
                      <div className="space-y-12">
                        ...
                        <div className="border-b border-gray-900/10 pb-12">
                          ...
                          <p className="mt-1 text-sm leading-6 text-gray-600">
                            We will always let you know about important changes,
