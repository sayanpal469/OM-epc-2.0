...
const CreateReportModal = ({ closeModal }) => {
  ...
  return (
    <div className="h-screen fixed inset-0 z-10 overflow-y-scroll bg-gray-100">
      <div
        className="w-full h-full overflow-scroll py-8 shadow-lg backdrop-blur-md backdrop-filter bg-opacity-50"
