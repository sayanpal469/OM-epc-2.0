...
import { BlobProvider, PDFDownloadLink, Page , Document, StyleSheet } from "@react-pdf/renderer";
...
const myDocs = (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      product_slNo={Form.product_slNo}
      buy_back_details={Form.buy_back_details}
      ...
      /> 
       <Part2
       AcInputThreePhase_RY={Form.ac_input_three_phase_RY}
       AcInputThreePhase_YB={Form.ac_input_three_phase_YB}
       AcInputThreePhase_RB={Form.ac_input_three_phase_RB}
       AcInputThreePhase_NR={Form.ac_input_three_phase_NR}
       AcOutputThreePhase_RY={Form.ac_output_three_phase_RY}
       AcOutputThreePhase_YB={Form.ac_output_three_phase_YB}
       AcOutputThreePhase_RB={Form.ac_output_three_phase_RB}
       AcOutputThreePhase_NR={Form.ac_output_three_phase_NR}
       AcInputSinglePhase_LN={Form.ac_input_single_phase_LN}
       AcInputSinglePhase_NE={Form.ac_input_single_phase_NE}
       AcInputSinglePhase_LE={Form.ac_input_single_phase_LE}
       AcOutputSinglePhase_LN={Form.ac_output_single_phase_LN}
       AcOutputSinglePhase_NE={Form.ac_output_single_phase_NE}
       AcOutputSinglePhase_LE={Form.ac_output_single_phase_LE}
       UpsInvertDCV={Form.V}
       DCV_WithMains={Form.V_withMains}
       DCV_WithoutMains={Form.V_withoutMains}
       power_cut={Form.power_cut}
       battery_make={Form.battery_make}
       battery_type={Form.battery_type}
       battery_AH={Form.battery_AH}
       quantity={Form.quantity}
       />
      <Part3
      BatteryData={Form.BatteryData}
